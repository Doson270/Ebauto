...
const Accueil = () => {
  return (
    <>
    <Helmet>
  <title>Garage Expert Bordeaux | Mécanique & Diagnostic Électronique</title>
...
<div className="pt-24 bg-gray-50 min-h-screen">
      ...
      <section className="bg-blue-950 text-white py-24 md:py-32 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center flex flex-col items-center">
            <div className="flex items-center gap-2 bg-blue-800/50 px-4 py-1 rounded-full text-sm text-blue-200 mb-6 border border-blue-700">
                <MapPin className="w-4 h-4" />
                <span>Situé à Bordeaux, 33000</span>
            </div>
          ...
          <div className="mt-12 flex flex-col sm:flex-row gap-4 items-center">
            <Link to="/Devis" className="bg-orange-500 text-white px-10 py-4 rounded-xl text-lg font-bold hover:bg-orange-600 transition shadow-lg w-full sm:w-auto">
      ...
      {/* 4. Section Services (Aperçu) */}
      <section className="py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center max-w-3xl mx-auto mb-16">
                <span className="text-blue-700 font-semibold">Nos Compétences</span>
                <h2 className="text-4xl font-extrabold tracking-tight text-blue-950 mt-2">Réparation mécanique et électronique en tout genre</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <div className="p-8 bg-white border border-gray-100 rounded-3xl hover:shadow-xl transition-shadow duration-300">
                    ...
                    <p className="text-gray-600 mt-3 text-sm leading-relaxed">Vidange, freins, distribution, embrayage. Entretien courant et réparations lourdes.</p>
                </div>
                {/* Service 2 */}
                <div className="p-8 bg-white border border-gray-100 rounded-3xl hover:shadow-xl transition-shadow duration-300">
                    <Cpu className="w-10 h-10 text-blue-600 mb-6"/>
                    <h4 className="text-xl font-bold text-blue-950">Passage à la Valise</h4>
                    <p className="text-gray-600 mt-3 text-sm leading-relaxed">Lecture et effacement des codes défauts, diagnostic précis des voyants moteur.</p>
                </div>
                {/* Service 3 */}
                <div className="p-8 bg-white border border-gray-100 rounded-3xl hover:shadow-xl transition-shadow duration-300">
                    <Zap className="w-10 h-10 text-orange-600 mb-6"/>
                    <h4 className="text-xl font-bold text-blue-950">Électricité Automobile</h4>
                    <p className="text-gray-600 mt-3 text-sm leading-relaxed">Réparation de faisceaux électriques, alternateurs, démarreurs, problèmes de batterie.</p>
                </div>
                {/* Service 4 */}
                <div className="p-8 bg-white border border-gray-100 rounded-3xl hover:shadow-xl transition-shadow duration-300">
                    <Star className="w-10 h-10 text-green-600 mb-6"/>
                    <h4 className="text-xl font-bold text-blue-950">Climatisation</h4>
                    <p className="text-gray-600 mt-3 text-sm leading-relaxed">Diagnostic de fuites, recharge de gaz, réparation du circuit de climatisation.</p>
                </div>
            </div>
        </div>
      </section>

      {/* 5. Témoignages Clients (Aperçu) */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div className="p-8 bg-white border border-gray-100 rounded-3xl shadow-sm">
                    ...
                    <p className="text-gray-700 leading-relaxed">"Le seul garage qui a réussi à réparer mon problème de faisceau électrique après deux échecs ailleurs. Un vrai expert en électronique."</p>
                ...
                <div className="p-8 bg-white border border-gray-100 rounded-3xl shadow-sm">
                    ...
                    <p className="text-gray-700 leading-relaxed">"Passage à la valise rapide, diagnostic clair et devis respecté. Ma voiture roule parfaitement à nouveau. Je recommande sans hésiter."</p>
                ...
                <div className="p-8 bg-white border border-gray-100 rounded-3xl shadow-sm">
                    ...
                    <p className="text-gray-700 leading-relaxed">"Accueil professionnel, mécanique impeccable sur ma courroie de distribution. Tout est clair, net et précis. C'est mon nouveau garage."</p>
      ...
      <footer className="py-10 bg-white border-t border-gray-100 text-center text-sm text-gray-500">
        © 2024 EBAutomobiles. Tous droits réservés.
      </footer>
    </div>
    </>
  );
